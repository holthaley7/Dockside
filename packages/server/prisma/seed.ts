...
const speciesData = [
  {
    ...
    sizeLimit: "none",
    migrationPatterns:
      "follow warm Pacific currents and bait concentrations, moving into San Diego range when water temps rise above 60°F, typically arriving in early summer and lingering through fall.",
    idealTides: "Outgoing or slack",
    idealDepths:
      'Targets range from the surface to deep "meter marks" shown on sonar. Details: Surface iron and fly-line baiting work during boils, while deep drops on kite or balloon rigs target fish marked at 50–200+ feet.',
  ...
  },
  {
    ...
    avgSize: "2-5 pounds max size of 10 pounds",
    bagLimit: "5 fish",
    sizeLimit: '14 inches total length or 10 inches alternate length',
    migrationPatterns:
      "remain in local waters year-round but move into shallow kelp forests to feed in warm months and retreat to deeper structure in cooler water.",
    idealTides: "low tides for lure fishing and high tides for bait fishing",
    idealDepths:
      "Typically targeted in coastal waters at depths up to 70 feet. Details: They reside within and around kelp canopy structures, rocky reef edges, and submerged ledges.",
  ...
  },
  {
    ...
    bagLimit: "10 fish as part of 20 fish general bag limit",
    sizeLimit: "none",
    migrationPatterns:
      "are tropical migrants that push north when water temperatures hit 72°F or higher, typically arriving in San Diego waters mid-summer and peaking in early fall.",
    idealTides: "Outgoing or slack",
    idealDepths:
      "Typically lurk between the surface and approximately 250 feet below. Details: Most frequently encountered near floating kelp paddies, debris fields, and current edges where baitfish congregate.",
    ...
    mustKnow:
      "ethically daily bag limit should be 6 per voyage and at least 28 inches",
  },
  {
    ...
    idealTides: "Outgoing or slack",
    idealDepths:
      "Found from the surface down to 130 feet. Details: In the spring and summer, they cruise the upper water column near kelp paddies and rocky structure; in winter they hold deeper near the islands.",
  ...
  },
  {
    ...
    idealDepths:
      "Generally found around rocky bottoms at 150 feet. Details: At the Coronado Islands and offshore banks, they hold near rocky pinnacles, ledges, and underwater canyon walls.",
  ...
  },
  {
    ...
    sizeLimit: "none",
    migrationPatterns:
      "inshore species that patrol shallow shore waters and sandy flats most actively during warmer months, retreating slightly deeper in winter.",
    idealTides: "Incoming high",
    idealDepths:
      "Associated with shallow nearshore waters and bays. Details: Within the nearshore zone, they favor sandy and muddy bottoms near jetties, piers, and along the surf line.",
    ...
    mustKnow:
      "cannot sell yellowfin croaker caught recreationally, as California and Mexican regulations prohibit the sale of recreationally caught fish.",
  },
  {
    ...
    avgSize: "5-20 pounds with larger reaching 30 pounds",
    ...
    idealDepths:
      "Most often caught by anglers in 10 to 90 feet of water. Details: These flatfish prefer sandy bottoms near kelp edges, channel drop-offs, and bay entrances where baitfish funnel.",
  ...
  },
  {
    ...
    avgSize: "1-3 pounds with max size of 6 pounds",
    bagLimit: "5 fish per day",
    ...
    idealTides: "Outgoing",
    idealDepths:
      "Found from just one foot of water down to 50 feet. Details: They are most commonly found in San Diego Bay, Mission Bay, and other estuaries around eelgrass beds and sandy structure.",
  ...
  },
  {
    ...
    idealDepths:
      "Inhabits waters ranging from inches deep at the surface down to 65 feet. Details: They cruise the wash zone and first trough of the surf, following sand crabs and other invertebrates.",
  ...
  },
  {
    ...
    migrationPatterns:
      "push into Southern California waters between mid-March and June, primarily following spawning squid runs along the kelp edges and rocky structure.",
    idealTides: "outgoing or slack",
    idealDepths:
      "Vertical distribution shifts toward the surface during warmer months. Details: Found along kelp bed edges, rocky reefs, and near squid spawning grounds at 30–120 feet.",
...
const generalInfo = [
  ...
  },
  {
    ...
    key: "Mousetrap Gear",
    value:
      '"Mousetrap" Gear: It is illegal to use or possess gear where hooks or lures are attached to a float not directly connected to the angler\'s line.',
    sortOrder: 2,
  },
  {
    category: "legal",
...
async function main() {
  ...
  for (const src of scanSources) {
    await prisma.scanSource.upsert({
      where: { id: src.name },
      update: src,
      create: src,
    });
